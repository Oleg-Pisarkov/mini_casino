...
class GameController extends Controller
{
    ...
    public function coinToss(Request $request)
    {
        ...
        $result = rand(0, 1);
        $win = ($result === 0 && $userChoice === 'heads') || ($result === 1 && $userChoice === 'tails');
    ...
    public function showHistory(Request $request)
    {
        ...
        $results = Result::where('user_id', Auth::id())->orderBy('created_at', 'desc')->paginate(10); // 10 записей на страницу
